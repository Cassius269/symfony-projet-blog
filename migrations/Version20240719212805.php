 ...
 */
final class Version20240719212805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE main_image_illustration (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) DEFAULT NULL, image_filename VARCHAR(255) NOT NULL, source VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
